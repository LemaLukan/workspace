...
public class NewTreeOfIntWithIterator extends AbstractList {
	private Node root = null;

    private class Node{
		private int value;
		private NewTreeOfIntWithIterator leftPtr;
		private NewTreeOfIntWithIterator rightPtr;

		public Node(int v){
			value = v;
			leftPtr = new NewTreeOfIntWithIterator();
			rightPtr = new NewTreeOfIntWithIterator();
		}
